...
# Heading for input
input_heading = tk.Label(input_frame, text="Enter the text to be translated", font=(font_style, font_size, 'bold'), bg="#f0f0f0")
input_heading.pack(anchor='w', pady=5)
# Text input for English sentence
text_input = tk.Text(input_frame, height=5, width=60, font=(font_style, font_size))
text_input.pack()

# Language selection
language_var = tk.StringVar()
language_label = tk.Label(root, text="Select the language to translate to", font=(font_style, font_size, 'bold'), bg="#f0f0f0")
...
# Heading for output
output_heading = tk.Label(output_frame, text="Translation: ", font=(font_style, font_size, 'bold'), bg="#f0f0f0")
output_heading.pack(anchor='w', pady=5)

# Text output for translations
translation_output = tk.Text(output_frame, height=10, width=60, font=(font_style, font_size))
